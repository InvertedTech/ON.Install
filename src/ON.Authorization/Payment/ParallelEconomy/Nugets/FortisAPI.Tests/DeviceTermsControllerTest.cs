...
namespace FortisAPI.Tests
{
    ...
    public class DeviceTermsControllerTest : ControllerTestBase
    {
        ...
        public async Task TestTestListAllDeviceTermsRelated()
        {
            ...
            Standard.Models.Sort2 sort = null;
            ...
            try
            {
                result = await this.controller.ListAllDeviceTermsRelatedAsync(page, sort, filter, expand);
            }
            catch (ApiException)
            {
            }
        ...
        public async Task TestTestViewSingleDeviceTermRecord()
        {
            ...
            try
            {
                result = await this.controller.ViewSingleDeviceTermRecordAsync(deviceTermsId);
            }
            catch (ApiException)
            {
            }
