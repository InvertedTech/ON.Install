...
| `BrandingDomain` | `object` | Optional | Branding domain array |
| `ProductTransactions` | `object` | Optional | Product Transactions array |
| `ProductFile` | `object` | Optional | Product file array |
