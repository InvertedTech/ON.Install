...
# V1 Transactions Tip Adjust Request
...
| `TipAmount` | `double` | Required | Optional tip amount. Tip is not supported for lodging and ecommerce merchants. Use only integer numbers, so $10.99 will be 1099.<br>**Constraints**: `<= 9999999999` |
