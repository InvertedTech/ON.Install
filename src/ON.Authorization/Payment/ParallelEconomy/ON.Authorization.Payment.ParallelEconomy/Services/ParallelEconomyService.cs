...
using ON.Authorization.Payment.ParallelEconomy.Clients;
...
namespace ON.Authorization.Payment.ParallelEconomy.Services
{
    public class ParallelEconomyService : ParallelEconomyInterface.ParallelEconomyInterfaceBase
    {
        ...
        public ParallelEconomyService(ILogger<ParallelEconomyService> logger, ISubscriptionRecordProvider subscriptionProvider, ParallelEconomyClient client, IOptions<AppSettings> settings)
        {
            this.logger = logger;
