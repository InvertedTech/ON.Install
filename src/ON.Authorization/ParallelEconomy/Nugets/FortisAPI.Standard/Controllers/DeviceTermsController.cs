...
namespace FortisAPI.Standard.Controllers
{
    ...
    public class DeviceTermsController : BaseController
    {
        ...
        internal DeviceTermsController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers, HttpCallBack httpCallBack = null)
        ...
        {
            Task<Models.ResponseAsyncProcessing> t = this.CreateANewDeviceTermAsync(body);
                ...
                CancellationToken cancellationToken = default)
        {
            ...
            queryBuilder.Append("/v1/device-terms");
        ...
        {
            Task<Models.ResponseDeviceTermsCollection> t = this.ListAllDeviceTermsRelatedAsync(page, sort, filter, expand);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
                ...
                CancellationToken cancellationToken = default)
        {
            ...
            return ApiHelper.JsonDeserialize<Models.ResponseDeviceTermsCollection>(response.Body);
        }
        ...
        {
            Task<Models.ResponseDeviceTerm> t = this.ViewSingleDeviceTermRecordAsync(deviceTermsId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
                ...
                CancellationToken cancellationToken = default)
        {
            ...
            // prepare query string for API call.
            StringBuilder queryBuilder = new StringBuilder(baseUri);
            queryBuilder.Append("/v1/device-terms/{device_terms_id}");

            // process optional template parameters.
            ApiHelper.AppendUrlWithTemplateParameters(queryBuilder, new Dictionary<string, object>()
            {
                { "device_terms_id", deviceTermsId },
            });
            ...
            return ApiHelper.JsonDeserialize<Models.ResponseDeviceTerm>(response.Body);
        }
    }
}