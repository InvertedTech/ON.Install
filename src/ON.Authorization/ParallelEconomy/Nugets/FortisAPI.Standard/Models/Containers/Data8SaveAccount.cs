...
namespace FortisAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Data8SaveAccount>),
        new Type[] {
            typeof(BooleanCase)
        },
        false
    )]
    public abstract class Data8SaveAccount
    {
        /// <summary>
        /// This is Boolean case.
        /// </summary>
        /// <returns>
        /// The Data8SaveAccount instance, wrapping the provided bool value.
        /// </returns>
        public static Data8SaveAccount FromBoolean(bool boolean)
        {
        ...
        private sealed class BooleanCase : Data8SaveAccount, ICaseValue<BooleanCase, bool>
        {
            public bool _value;
