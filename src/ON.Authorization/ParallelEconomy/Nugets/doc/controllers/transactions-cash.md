...
```csharp
TransactionsCashController transactionsCashController = client.TransactionsCashController;
```
...
* [Cash Refund](../../doc/controllers/transactions-cash.md#cash-refund)
* [Cash Sale](../../doc/controllers/transactions-cash.md#cash-sale)
...
|  --- | --- | --- | --- |
| `body` | [`V1TransactionsCashRefundRequest`](../../doc/models/v1-transactions-cash-refund-request.md) | Body, Required | - |
...
```csharp
V1TransactionsCashRefundRequest body = new V1TransactionsCashRefundRequest
{
    TransactionAmount = 1,
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`V1TransactionsCashSaleRequest`](../../doc/models/v1-transactions-cash-sale-request.md) | Body, Required | - |
...
```csharp
V1TransactionsCashSaleRequest body = new V1TransactionsCashSaleRequest
{
    TransactionAmount = 1,
    CheckinDate = "2021-12-01",
    CheckoutDate = "2021-12-01",
