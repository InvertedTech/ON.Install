...
| `AccountNumber` | [`List15AccountNumber`](../../doc/models/containers/list-15-account-number.md) | Optional | This is a container for one-of cases.<br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `19`, *Pattern*: `^[\d]+$` |
