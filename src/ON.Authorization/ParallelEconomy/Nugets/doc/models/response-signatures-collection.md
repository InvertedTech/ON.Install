...
|  --- | --- | --- | --- |
| `Type` | `string` | Required, Constant | Resource Type<br>**Default**: `"SignaturesCollection"` |
| `List` | [`List<List11>`](../../doc/models/list-11.md) | Required | Resource Members |
