...
# V1 Transactions Cc Refund Keyed Request
...
| `AccountNumber` | [`V1TransactionsCcRefundKeyedRequestAccountNumber`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-account-number.md) | Optional | This is a container for any-of cases. |
...
| `ExpDate` | [`V1TransactionsCcRefundKeyedRequestExpDate`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-exp-date.md) | Optional | This is a container for any-of cases. |
| `TrackData` | `string` | Optional | Track Data from a magnetic card swipe.<br>**Constraints**: *Maximum Length*: `256` |
| `PreviousTransactionId` | `string` | Optional | previous_transaction_id is used as token to run transaction. Account details OR previous_transaction_id should be passed to run transaction.<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
