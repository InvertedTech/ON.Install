...
# V1 Transactions Cc Auth Only Keyed Request
...
| `EFormat` | [`Models.EFormatEnum?`](../../doc/models/e-format-enum.md) | Optional | Encrypted Track Data Format. |
...
| `TrackData` | `string` | Optional | Tags<br>**Constraints**: *Maximum Length*: `256` |
