...
| `AccountNumber` | [`V1TokensTicketRequestAccountNumber`](../../doc/models/containers/v1-tokens-ticket-request-account-number.md) | Optional | This is a container for one-of cases.<br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `19`, *Pattern*: `^[\d]+$` |
...
| `Ticket` | `string` | Required | A valid ticket that was created to store the token.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36` |
